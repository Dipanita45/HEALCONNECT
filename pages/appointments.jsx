...
const doctors = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1673865641073-4479f93a7776?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    available: true,
  ...
  const handleDoctorSelect = (doctor) => {
    ...
    if (!user && !localStorage.getItem("userType")) {
      ...
      const confirmLogin = window.confirm(
        "You must be logged in to book an appointment. Proceed to login?",
      );
      if (confirmLogin) {
        router.push("/login");
      }
          ...
          {step === 1 ? (
            ...
            >
              <div
                ...
                style={{ paddingTop: "2.5rem", position: "relative" }}
              >
                <motion.button
