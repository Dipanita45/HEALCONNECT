...
export default function Hero({ scrollToSection }) {
    return (
        <section id="hero" className="min-h-screen flex items-center relative px-5 overflow-hidden">
            ...
            <div className="absolute inset-0 w-full h-full -z-10 overflow-hidden">
                ...
                <motion.div
                    className="absolute rounded-full bg-gradient-radial from-blue-500/10 to-transparent"
                    style={{ width: '700px', height: '700px', bottom: '-20%', left: '-20%' }}
            ...
            <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-10 items-center">
                <div className="max-w-2xl">
                    <motion.h1
                        ...
                        className="text-5xl md:text-6xl font-extrabold mb-6 text-slate-800 leading-tight"
                    >
                ...
                <div className="flex justify-center relative">
                    <motion.div
                        ...
                        className="relative rounded-xl overflow-hidden shadow-2xl shadow-blue-500/20"
                    >
                        <Image
                            src="/dashboard.svg"
            ...
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 cursor-pointer z-10" onClick={() => scrollToSection('problem')}>
                ...
                >
                    <div className="w-3 h-3 border-r-2 border-b-2 border-slate-400 rotate-45"></div>
                    <div className="w-3 h-3 border-r-2 border-b-2 border-slate-400 rotate-45 -mt-1.5 opacity-50"></div>
                </motion.div>
            </div>
        </section>
    );
